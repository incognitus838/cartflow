...
export const PRODUCT_TYPE_CONFIG: Record<ProductType, ProductTypeConfig> = {
  ...
  FOOD: {
    title: "Food & farm produce details",
    subtitle: "Fresh items with expiry, prep time, and how you fulfil orders.",
    titlePlaceholder: "Organic Yams — 5 tubers",
    descriptionPlaceholder: "Farm source, freshness, storage, and how orders are packed.",
    categoryPlaceholder: "Farm Produce, Bakery, Prepared Meals",
    showStock: true,
    showLowStock: true,
    showVariants: true,
