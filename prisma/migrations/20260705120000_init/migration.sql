...
-- CreateEnum
CREATE TYPE "BusinessPlan" AS ENUM ('FREE', 'STARTER', 'PRO', 'ENTERPRISE');
...
-- CreateIndex
CREATE INDEX "InventoryLog_businessId_idx" ON "InventoryLog"("businessId");
...
-- AddForeignKey
ALTER TABLE "InventoryLog" ADD CONSTRAINT "InventoryLog_businessId_fkey" FOREIGN KEY ("businessId") REFERENCES "Business"("id") ON DELETE CASCADE ON UPDATE CASCADE;
